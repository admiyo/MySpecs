...
Version:   1.2.7
Release:        2%{?dist}
Summary:       Java Processing for the Fast Infoset document format

Group:         Development/Java
License:        GPL
URL:            http://repo2.maven.org/maven2/com/sun/xml/fastinfoset/FastInfoset/1.2.7/
...
%description
See http://java.sun.com/developer/technicalArticles/xml/fastinfoset/
