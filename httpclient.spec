...
BuildRequires: httpcore = 4.0.1
BuildRequires: jakarta-commons-logging  
BuildRequires: commons-codec 
BuildRequires: junit >= 3.8
Requires: httpcore = 4.0.1
...
%build
javac -d classes -cp src/:%{_javadir}/httpcore.jar:%{_javadir}/commons-logging.jar:%{_javadir}/commons-codec.jar:%{_javadir}/junit.jar  `find . -name *.java` 
javadoc -d javadoc -classpath src/:%{_javadir}/httpcore.jar:%{_javadir}/commons-logging.jar:%{_javadir}/commons-codec.jar:%{_javadir}/junit.jar  $(for JAVA in `find src/ -name *.java` ; do  dirname $JAVA ; done | sort -u  | sed -e 's!src.!!'  -e 's!/!.!g'  )
